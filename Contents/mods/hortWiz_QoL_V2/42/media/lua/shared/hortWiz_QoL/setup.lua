...
function hortWiz_QoL.is_zombie_outline_enabled()
  return _is_zombie_outline_enabled
end

function hortWiz_QoL.set_zombie_outline_enabled(enabled)
...
function hortWiz_QoL.get_zombie_outline_custom_color()
  return r, g, b, a
end

function hortWiz_QoL.update_zombie_outline_custom_color(new_r, new_g, new_b, new_a)
  r = new_r or r
  g = new_g or g
  b = new_b or b
  a = new_a or a
...
function hortWiz_QoL.is_feature_enabled(feature_key)
  return _feature_toggles[feature_key] ~= false
end

function hortWiz_QoL.set_feature_enabled(feature_key, enabled)
...
function hortWiz_QoL.get_broken_weapon_behavior()
  return _broken_weapon_behavior
end

function hortWiz_QoL.set_broken_weapon_behavior(behavior)
